...
export const browseCategories = {
  women: [
    ...
    { name: "Clothing (Veshje)", href: "/browse/women/clothing" },
    { name: "Shoes (Këpucë)", href: "/browse/women/shoes" },
  ...
  men: [
    ...
    { name: "Clothing (Veshje)", href: "/browse/men/clothing" },
    { name: "Shoes (Këpucë)", href: "/browse/men/shoes" },
