...
import WebProfileListingsSalesPage from '@/app/profile/listings/sales/[orderId]/client-page';

/**
 * Native stand-in for `/profile/listings/sales/[orderId]`.
 *
