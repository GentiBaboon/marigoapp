...
const navItems = [
  ...
  { href: '/admin/offers', label: 'Offers', icon: Handshake, permission: 'offers.view' as AdminPermission },
  ...
  { href: '/admin/support', label: 'Assistant Chats', icon: Bot, permission: 'support.manage' as AdminPermission },
  { href: '/admin/messages', label: 'Messages', icon: MessagesSquare, permission: 'messages.view' as AdminPermission },
